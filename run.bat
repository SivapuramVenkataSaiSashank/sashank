@echo off
echo ============================================================
echo   VoiceRead - AI Reading Assistant for Blind Learners
...
start "VoiceRead Backend" cmd /k "call venv\Scripts\activate && python -m uvicorn api:app --host 0.0.0.0 --port 8080 --reload"

timeout /t 3 /nobreak >nul

echo [5] Starting React frontend  http://localhost:5173 ...
start "VoiceRead Frontend" cmd /k "cd frontend && npm run dev"

echo.
echo ============================================================
echo   VoiceRead is live!
